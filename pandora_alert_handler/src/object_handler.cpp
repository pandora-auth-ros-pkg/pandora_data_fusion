...
{
  keepValidVerificationObjects<Face>(newFaces);
...
{
  keepValidVerificationObjects<Motion>(newMotions);
...
{
  keepValidVerificationObjects<Sound>(newSounds);
...
{
  keepValidVerificationObjects<Co2>(newCo2s);
