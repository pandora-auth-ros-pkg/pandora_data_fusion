...
#include "data_fusion/AlertHandlerConfig.h"
...
class AlertHandler : public StateClient {
 ...
 private:
  ...
  void dynamicReconfigCallback(
      data_fusion::AlertHandlerConfig &config,
        uint32_t level);
 ...
 private:
  ...
  dynamic_reconfigure::Server<data_fusion::AlertHandlerConfig> dynReconfserver_;
